  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      const aiMessage = {
        id: Date.now() + 1,
        type: 'assistant',
        content: `I understand you're asking about "${currentQuestion}". Based on the context and any attached files, here's my response:\n\nThis is a comprehensive answer that addresses your question with detailed explanations and relevant examples. I can help you understand complex concepts by breaking them down into simpler parts.\n\nWould you like me to elaborate on any specific aspect of this topic?`,
        timestamp: new Date()
      }
